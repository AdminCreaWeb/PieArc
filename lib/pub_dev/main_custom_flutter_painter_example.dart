...
//       theme: ThemeData(
//           primaryColor: Colors.brown, hintColor: Colors.amber, canvasColor: Colors.grey[200]),
...
//                     IconButton(
//                       icon: Icon(
//                         PhosphorIcons.trash as IconData?,
//                       ),
...
//                     IconButton(
//                       icon: Icon(
//                         PhosphorIcons.arrowClockwise as IconData?,
//                       ),
...
//                     IconButton(
//                       icon: Icon(
//                         PhosphorIcons.arrowCounterClockwise as IconData?,
//                       ),
...
//               IconButton(
//                 icon: Icon(
//                   PhosphorIcons.eraser as IconData?,
...
//               IconButton(
//                 icon: Icon(
//                   PhosphorIcons.scribbleLoop as IconData?,
...
//               IconButton(
//                 icon: Icon(
//                   PhosphorIcons.textT as IconData?,
...
//               IconButton(
//                 icon: Icon(
//                   PhosphorIcons.sticker as IconData?,
//                 ),
...
//                             children: [
//                               Icon(
//                                 getShapeIcon(e.key) as IconData?,
//                                 color: Colors.black,
//                               ),
//                               Text(" ${e.value}")
//                             ],
...
//                     child: Icon(
//                       getShapeIcon(controller.shapeFactory) as IconData?,
